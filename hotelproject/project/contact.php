...
<html lang="en">
  <head>
    ...
    <title>MOON Hotel-contact</title>
...
<div class= "container">
  ...
  <div class="col-lg-6 col-md-6 mb-5 px-4">
    ...
    <iframe class="w-150 rounded" height="350px" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d253118.98539746748!2d79.53191222499999!3d7.576703800000012!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3ae2c9569155014f%3A0xc4199b4b6bd0f2e0!2sChilaw%20town!5e0!3m2!1sen!2slk!4v1745214002130!5m2!1sen!2slk"   ></iframe>
    <h5>Address</h5>
    <a herf="https://maps.app.goo.gl/gQLwuBkaACKtKMyp6">
     <i class="bi bi-geo-alt-fill"></i>  Chilawa town, Trinco.
     </a>
     <br>
     <h5 class="mt-4"> Call Us</h5>
        ...
        <br>
        <a href="tel:+94770082290"class="d-inline-block mb-2 text-decoration-none text-dark">
        <i class="bi bi-telephone-fill"></i>+94410082290
        </a>
  
        <h5 class="mt-4"> E mail</h5>
        <a href="moonhotel@gmail.com" class="d-inline-block mb-2 text-decoration-none text-dark">
       <i class="bi bi-envelope-at-fill"></i> moonhotel@gmail.com
        </a>
    ...
    <div class="col-lg-6 col-md-6 mb-5 px-4">
        <div class="bg-white rounded shadow p-4">
          <form>
            ...
            <div class="mb-3">
          <label class="form-label" style="font-weight:50;">Name</label>
          <input type="text" class="form-control shadow-none ">
          </div>
          <div class="mb-3">
          <label class="form-label" style="font-weight:50;">Email</label>
          <input type="email" class="form-control shadow-none ">
          </div>
          <div class="mb-3">
          <label class="form-label" style="font-weight:50;">Subject</label>
          <input type="text" class="form-control shadow-none ">
          </div>
          <div class="mb-3">
          <label class="form-label" style="font-weight:50;">Message</label>
          <br>
          <textarea class="form-control shadow-none" rows="5" style="resize:5;"></textarea>
          </div>
